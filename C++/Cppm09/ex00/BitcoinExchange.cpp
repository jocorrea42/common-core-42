...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024-04-15 09:16:30 by fili              #+#    #+#             */
/*   Updated: 2024-04-15 09:16:30 by fili             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
BitcoinExchange::BitcoinExchange(const std::string &filename)
{
	...
	while (std::getline(file, line))
	{
		...
		{
			std::cerr << "Error: Invalid format in db => " << line << '\n';
			continue;
		}
		...
		if (!(rate_stream >> rate))
		{
			std::cerr << "Error: Invalid rate format in db => "<< rate_str << '\n';
			continue;
		}
		data_[date] = rate;
	}
